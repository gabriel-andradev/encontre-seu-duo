...
app.post('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ad = yield prisma.ad.create({
        data: {
            ...
            hourStart: (0, convert_hour_string_to_minute_1.convertHourStringToMinute)(body.hourStart),
            hourEnd: (0, convert_hour_string_to_minute_1.convertHourStringToMinute)(body.hourEnd),
